...
If you are using this action from a .NET library repository, the shipped and unshipped files are typically generated by [Microsoft.CodeAnalysis.PublicApiAnalyzers](https://www.nuget.org/packages/Microsoft.CodeAnalysis.PublicApiAnalyzers).
